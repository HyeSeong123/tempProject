...
<div class="container-fluid padding-lg-0l padding-lg-0r section">
	...
	<script>
		function modifyArticleFormSubmit(form){
			let modifyArticleForm_submited = false;
			
			if (modifyArticleForm_submited) {
					alert('처리중입니다.');
					return;
				}
		...
		modifyArticleForm_submited = true;
		
		startUploadFiles(startSubmitForm);
	}
	</script>

			<form action="doModify" method="POST" onsubmit="modifyArticleFormSubmit(this); return false;" enctype="multipart/form-data">
				...
				<table class="write">
					...
					<tbody>
						...
						<tr>
							<th>내용</th>
							<td><textarea name="body" id="" cols="30" rows="10" >${article.body}</textarea></td>
						</tr>
