	...
	<div class="container-fluid padding-lg-0l padding-lg-0r section">
		<div class="container">
			<div class="tbl_top">
				<div class="sch">
					<a
						href="add?boardNum=${board.num}&redirectUrl=${encodedRequestUrl}">글쓰기</a>
					<form>
						...
						<input type="text" class="sch_input" name="searchKeyword"
					...
					<tbody>
						...
						<c:forEach items="${articles}" var="article">
							<tr>
								...
								<td>
									<a
										href="detail?num=${article.num}&redirectUrl=${encodedRequestUrl}">${article.title}</a>
								</td>
			...
			<div class="paging">
				<ul class="pagination">
					...
					<c:if test="${page != pageMenuStart}">
						<li>
							<a
								href="list?boardNum=${board.num}&page=1&searchKeyword=${param.searchKeyword}&searchKeywordType=${param.searchKeywordType}"
								class="ctrl fir" onclick="">
						...
						<li>
							<a
								href="list?boardNum=${board.num}&page=${page-1}&searchKeyword=${param.searchKeyword}&searchKeywordType=${param.searchKeywordType}"
								class="ctrl prev" onclick="">
					...
					<c:forEach var="i" begin="${pageMenuStart}" end="${pageMenuEnd}">
						<li>
							...
							<a class="${className} num"
								href="list?boardNum=${board.num}&page=${i}&searchKeyword=${param.searchKeyword}&searchKeywordType=${param.searchKeywordType}">${i}</a>
						</li>
					</c:forEach>
					...
					<c:if test="${page != pageMenuEnd and totalCount != 0}">
						...
						<li>
							<a
								href="list?boardNum=${board.num}&page=${pageMenuEnd}&searchKeyword=${param.searchKeyword}&searchKeywordType=${param.searchKeywordType}"
								class="ctrl las" onclick="">
			...
			<div class="gallery_wrap">
				<ul class="gallery_ul">
					...
					<c:forEach items="${articles}" var="article">
						<li>
							<a
								href="detail?num=${article.num}&redirectUrl=${encodedRequestUrl}">
								<div class="img_box">
