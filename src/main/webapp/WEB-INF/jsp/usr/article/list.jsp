            ...
            <div class="paging">
                <ul class="pagination">
                	...
                	<c:if test="${page != pageMenuStart}">
	                    <li>
	                        <a href="list?boardNum=${board.num}&page=1&searchKeyword=${param.searchKeyword}&searchKeywordType=${param.searchKeywordType}" class="ctrl fir" onclick=""><span class="blind">처음</span></a>
	                    </li>

	                    <li>
	                        <a href="list?boardNum=${board.num}&page=${page-1}&searchKeyword=${param.searchKeyword}&searchKeywordType=${param.searchKeywordType}" class="ctrl prev" onclick=""><span class="blind">이전</span></a>
	                    </li>
                    ...
                    <c:forEach var="i" begin="${pageMenuStart}" end="${pageMenuEnd}">
                    	<li>
							...
							<a class="${className} num" href="list?boardNum=${board.num}&page=${i}&searchKeyword=${param.searchKeyword}&searchKeywordType=${param.searchKeywordType}">${i}</a>
						</li>
                    </c:forEach>
                    
                    <c:if test="${page != pageMenuEnd and totalCount != 0}">
	                    <li>
	                        <a href="list?boardNum=${board.num}&page=${page+1}&searchKeyword=${param.searchKeyword}&searchKeywordType=${param.searchKeywordType}" class="ctrl next" onclick=""><span class="blind">다음</span></a>
	                    </li>
	                    
	         			<li>
	                        <a href="list?boardNum=${board.num}&page=${pageMenuEnd}&searchKeyword=${param.searchKeyword}&searchKeywordType=${param.searchKeywordType}" class="ctrl las" onclick=""><span class="blind">마지막</span></a>
	                    </li>
                    </c:if>
