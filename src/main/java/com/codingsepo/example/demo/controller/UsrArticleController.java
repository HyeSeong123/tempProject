...
public class UsrArticleController {
	...
	public String doAdd(@RequestParam Map<String, Object> param, HttpSession session, HttpServletRequest req, MultipartRequest multipartRequest) {
	...
	*/
	...
	public String doAddTest(@RequestParam Map<String, Object> param, HttpSession session, HttpServletRequest req, MultipartRequest multipartRequest) {
		int loginedMemberNum = Util.getAsInt(session.getAttribute("loginedMemberNum"), 0);
		...
		return Util.msgAndReplace(req, "작성이 완료되었습니다.", "/usr/article/photoList?boardNum=" + param.get("boardNum"));
	}
	...
	public String showDetail(Integer num,HttpServletRequest req, Model model, String redirectUrl) {
		...
		System.out.println("detail redirectUrl=" + redirectUrl);
	...
	public String showList(int boardNum, HttpServletRequest req) {
		
		if(boardNum ==1) {
			return "usr/article/normalList";
		}
		
		else if(boardNum ==2) {
			return "usr/article/photoList";
		}
		
		return Util.msgAndBack(req, "잘못된 접근입니다.");
	}
	
	@RequestMapping("/usr/article/normalList")
	public String showList(@RequestParam(defaultValue = "1") int page,@RequestParam( defaultValue = "1") int boardNum, HttpServletRequest req, Model model,
	...
	@RequestMapping("/usr/article/photoList")
	public String showPhothoList(@RequestParam(defaultValue = "1") int page,@RequestParam( defaultValue = "1") int boardNum, HttpServletRequest req, Model model,
			@RequestParam(defaultValue = "titleAndBody") String searchKeywordType, String searchKeyword) {
